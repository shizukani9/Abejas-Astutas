...
Then('I have a bug story in the backlog', async function() {
    // Verificar la existencia del botón 'Add Story'
...
Then('I delete the bug type story from the backlog', async function() {
    // Esperar a que el botón 'Delete' esté habilitado y luego hacer clic en él
    ...
    // Esperar a que el botón de confirmación de eliminación esté visible y luego hacer clic en él
...
Then('I should see the backlog empty', async function() {
    // Verificar que el mensaje de backlog vacío esté presente
